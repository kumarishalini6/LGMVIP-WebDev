...
<html lang="en" dir="ltr">
   <head>
      ...
      <link rel="stylesheet" href="../stylesheet/studentlogin.css">
...
if(isset($_POST["submit"]))
{
   ...
   $USERNAME = $_POST['name'];
   $PASSWORD = $_POST['psw'];
   $qry="SELECT * FROM `studentlogin` WHERE `user_name`='$USERNAME' AND `user_password`='$PASSWORD'";
   ...
   if($row<1)
    {
       ...
       <script>
         window.open('../pages/findresult.php','_self');
       </script>
       <?php
    }
}
