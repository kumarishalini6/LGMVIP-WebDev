...
<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >&#9776; Dashboard</span>
	...
	<div class="profile">
		<button>
    <a href="logout.php" style="color:red;outline:none;border:none;">LOGOUT</a>
        </button>
	</div>
</div>
...
<div class="col">
        ...
        <table class="table1">
            <h1 align="center" style="color:white;">Search Student and Update Marks</h1>
            <tr>
            <th>Student Class</th>
            <td><input type="text" name="class"/></td>
            <th>Student Rollno</th>
            <td><input type="text" name="rollno"/></td>
                <th><button type="submit" name="submit" value="Submit" class="submit" ><a>Search</a></button></th>
         ...
         <?php
            ...
            <th class="student_class2"><a href="updateform.php?sid=<?php echo $data['u_rollno']; ?>" style="color:red;">Edit</a></th> 
