  ...
  if(mysqli_num_rows($run)>0)
{
     while($row=mysqli_fetch_assoc($run))
     {
        ...
        <tr>
            ...
            <th class="name_h"> <?php  echo $row['user_name'].'<br>'; ?></th> 
            <th class="email_h"> <?php  echo $row['user_email'].'<br>'; ?></th> 
            <th class="contact_h"> <?php  echo $row['user_contact'].'<br>'; ?></th> 
            <th class="massage_h"> <?php  echo $row['user_message'].'<br>'; ?></th> 
        </tr>     
        <?php    
        }
